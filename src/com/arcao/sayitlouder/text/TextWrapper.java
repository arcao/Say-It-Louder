...
public class TextWrapper {
	 ...
	 * specified by <code>Breakable</code>. Will also remove all existing
	 * newlines.
	 * 
	 * @param text
	 *          Text to be cleansed.
	 ...
	 * @param targetRatio
	 *          Ratio (height / width) of the target area for this text.
	 * @param fontRatio
	 *          Average ratio (height / width) of a single character.
	...
	/**
	 * Find the best place to break text given a starting index and a search
	 * radius.
	 * 
	 * @param text
	 *          Full text to search through.
	 * @param start
	 *          Index in string to start searching at. Will be used as the center
	 *          of the radius.
	 * @param radius
	 *          Radius (in characters) to search around the given starting index.
